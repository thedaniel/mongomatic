...
Unlike ActiveRecord the existence of a CollectionNameObserver will not automatically add the observer to the CollectionName class. Instead you must use the observer macro or CollectionName.add_observer
